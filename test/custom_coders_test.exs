...
#   defp encoder(%TypeInfo{send: "int4"}, default, value) do
#     default.(value + 1)
#   end
...
#   defp decoder(%TypeInfo{send: "int4"}, _format, default, bin) do
#     default.(bin) + 10
#   end
...
#   defp formatter(%TypeInfo{send: "float8"}), do: :text
#   defp formatter(%TypeInfo{send: "uuid"}), do: :text
